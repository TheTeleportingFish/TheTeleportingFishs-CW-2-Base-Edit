...
if CLIENT then
	...
	SWEP.PrintName = "MP5 Player"
	SWEP.CSMuzzleFlashes = true
	SWEP.ViewModelMovementScale = 0.35
	...
	SWEP.SprintPos = Vector(0.444, -1, -2.082)
	...
	SWEP.LuaVMRecoilAxisMod = {vert = 3, hor = 3, roll = 22, forward = 3, pitch = 3}
...
SWEP.Attachments = {[1] = {header = "Sight", offset = {700, -650}, atts = {"md_microt1", "md_eotech", "md_aimpoint", "md_schmidt_shortdot", "md_acog"}},
[2] = {header = "Barrel", offset = {200, -400}, atts = {"md_tundra9mm"}, exclusions = {bg_mp5p_sdbarrel = true}},
[3] = {header = "Handguard", offset = {-400, -400}, atts = {"bg_mp5p_kbarrel", "bg_mp5p_sdbarrel"}},
[4] = {header = "Magazine", offset = {-400, 100}, atts = {"bg_mp530rndmag"}},
[5] = {header = "Stock", offset = {700, 300}, atts = {"bg_mp5p_retractablestock", "bg_mp5p_nostock"}},
["+reload"] = {header = "Ammo", offset = {700, -250}, atts = {"am_magnum", "am_matchgrade", "am_antimaterial", "am_heirounds", "am_headrounds"}}}
...
SWEP.Sounds = {draw = {{time = 0, sound = "CW_FOLEY_MEDIUM"}},
	...
	reloadfull = {[1] = {time = 1.1, sound = "CW_MP5P_MAGOUT"},
	[2] = {time = 1.4, sound = "CW_MP5P_MAGIN"}},
	
	reloadempty = {[1] = {time = 0.4, sound = "CW_MP5P_BOLTBACK"},
	[2] = {time = 1.5, sound = "CW_MP5P_MAGOUT"},
	[3] = {time = 1.8, sound = "CW_MP5P_MAGIN"},
	[4] = {time = 2.6, sound = "CW_MP5P_BOLTFORWARD"}}}
...
SWEP.FireDelay = 0.12
SWEP.FireSound = "CW_MP5P_FIRE"
SWEP.FireSoundSuppressed = "CW_MP5P_FIRE_SUPPRESSED"
SWEP.Recoil = 0.3
