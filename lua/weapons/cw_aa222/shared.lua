...
if CLIENT then
	...
	SWEP.PrintName = "AA-222"
	SWEP.CSMuzzleFlashes = true
	SWEP.ViewModelMovementScale = 5.15
	...
	SWEP.ForeGripOffsetCycle_Reload = 1.1
	SWEP.ForeGripOffsetCycle_Reload_Empty = 0.79
	
	SWEP.M203OffsetCycle_Reload = 0.73
	SWEP.M203OffsetCycle_Reload_Empty = 0.6
	...
	SWEP.M203Pos = Vector(-1.562, -2.481, -3.24)
	SWEP.M203Ang = Vector(42, -2, -10)
	...
	SWEP.AttachmentPosDependency = {["md_anpeq15"] = {["bg_alongris"] = Vector(-0.225, 13, 3.15)},
	["md_saker"] = {["bg_longbarrel"] = Vector(-0.042, 9, -0.1), ["bg_alongris"] = Vector(-0.042, 9, -0.1)}}
...
SWEP.Attachments = {[1] = {header = "Sight", offset = {800, -500}, atts = {"bg_foldsight", "md_microt1", "md_eotech", "md_aimpoint", "md_schmidt_shortdot", "md_acog"}},
	...
	[3] = {header = "Receiver", offset = {-400, -500}, atts = {"bg_magpulhandguard", "bg_alongbarrel", "bg_ris", "bg_alongris"}},
	[4] = {header = "Handguard", offset = {-400, 0}, atts = {"md_foregrip", "md_m203"}},
	[5] = {header = "Magazine", offset = {-400, 400}, atts = {"bg_aa222130rndmag"}},
...
SWEP.AttachmentDependencies = {["md_m203"] = {"bg_alongris"}} -- this is on a PER ATTACHMENT basis, NOTE: the exclusions and dependencies in the Attachments table is PER CATEGORY
...
SWEP.Sounds = {draw = {{time = 0, sound = "CW_FOLEY_MEDIUM"}},
	...
	reload = {[1] = {time = 0.35, sound = "CW_AA222_MAGOUT"},
	[2] = {time = 1.2, sound = "CW_AA222_MAGIN"},
	[3] = {time = 1.9, sound = "CW_AA222_BOLT"}}}
...
SWEP.FireDelay = 0.0499
SWEP.FireSound = "CW_AA222_FIRE"
SWEP.FireSoundSuppressed = "CW_AA222_FIRE_SUPPRESSED"
SWEP.Recoil = 0.85
